    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1>Instancia Estabilizacion</h1>
                        ...
                        <a href="./bashonest.php"type="button" class="btn btn-success btn-xs">Encender</a>
                        <a href="./bashoffest.php"type="button" class="btn btn-danger btn-xs">Apagar</a>
                        </p>
