            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <button href="./bashoncon.php" type="button" class="btn btn-success btn-xs">Encender</button>
                        <button href="./bashoffcon.php" type="button" class="btn btn-danger btn-xs">Apagar</button>
                        </p>
