    ...
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <li>
                    <a href="http://app.s4ds.com/s4ds-back/monitoring" target = "container">JavaMelody Back</a>
                </li>
                <li>
...
>                    <div class="col-lg-12">
        ...
        <!-- /#page-content-wrapper -->
         <iframe id="container" name="container"  style="width:100%; height:3000px; border:none" src="http://app.s4ds.com/s4ds-back/monitoring"></iframe>
